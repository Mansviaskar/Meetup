...
const Dashboard = () => {
  ...
  return (
    <div className="flex-1 max-w-7x1 w-full mx-auto p-6 md:p-12 flex flex-col justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="space-y-3">
            ...
            <h1 className="text-4x1 sm:text-5x1 text-slate-800 leading-tight font-medium">
              High Quality Video Calls. <br />
              <span className='text-primary'>Built for everyone.</span>
            </h1>
            <p className="text-slate-700 text-base sm:text-lg max-w-x1 leading-relaxed"> 
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              ...
              <form onSubmit={handleJoinMeeting} className='flex-1 flex items-center gap-2'>
                <div className="relative flex-1">
                  ...
                  <input type="text" placeholder="Enter meeting code (eg. abc-def-ghi)" value={joinId} onChange={(e)=>setJoinId(e.target.value)}
                  className="w-full bg-white/75 border border-primary-border/80 focus:border-primary/60 focus:ring-1 focus:ring-primary/60 rounded-full pl-12 pr-3.5 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all"/>
                </div>
                <button type='submit'
        ...
        {/*Right column - hero graphic 7 clock card */}
