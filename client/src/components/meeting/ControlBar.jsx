        ...
        <div className='flex items-center gap-3 mx-auto sm:mx-0'>
            ...
            title="Toggle In-Meeting Chat">
                ...
                {unreadCount > 0 && !isChatOpen && (
                    <span className='absolute -top-1 -right-1 bg-primary text-white text-[10px] font-bold w-5 h-5 
                    rounded-full flex items-center justify-center border-2 border-white shadow-xs'>
                        {unreadCount}
                    </span>
                )}
            </button>
            ...
            {isHost ? (
                ...
                transition-all cursor-pointer border border-red-500 ml-2'
                title='Leave Meeting'>
                    <PhoneOffIcon className='w-5 h-5'/>
                </button>
            )}
