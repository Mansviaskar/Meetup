...
const Navbar = () => {
  ...
  return (
    <header className="w-full max-w-305 mx-auto bg-white/90 backdrop-blur x1:rounded-b-x1 sticky top-0 z-40 px-6 py-4 flex items-center justify-between border border-slate-200">
